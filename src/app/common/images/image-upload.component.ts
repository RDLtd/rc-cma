    ...
    this.myWidget = (window as any).cloudinary.createUploadWidget(
      {
        ...
        folder: `restaurants/${this.restaurant.restaurant_number}`, //upload files to the specified folder
        tags: ["event"], //add the given tags to the uploaded files
        // context: {alt: "user_uploaded"}, //add the given context data to the uploaded files
        clientAllowedFormats: ["jpg","jpeg","gif","webp"], //restrict uploading to image files only
