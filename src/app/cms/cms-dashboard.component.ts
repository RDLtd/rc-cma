...
export class CmsDashboardComponent implements OnInit, AfterViewInit {
  ...
  verifyData(): void {
    ...
    this.restaurantService.verify(this.restaurant.restaurant_id,
      ...
      .subscribe(data => {
        // console.log(data);
        this.cmsLocalService.dpsSnackbar(this.t_data.DataVnP, 'OK', 5);
        ...
        if (f.valid) {
          ...
          this.cms.sendRestaurantChanges(currentMember, this.restaurant, changeArray)
            .subscribe(data => {
                ...
                this.cmsLocalService.dpsSnackbar(this.t_data.ChangeSent, 'OK', 5);
                // record event
  ...
  copied(): void {
    this.cmsLocalService.dpsSnackbar(this.t_data.LinkCopied, 'OK', 5);
    // record event
