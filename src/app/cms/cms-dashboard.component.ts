            ...
            .subscribe(data => {
              ...
              // TODO Add to translation
                const msg = this.t_data.DataChange;
                  ...
                  // 'Please be aware that you may not see any changes for upto 24' +
                  // ' hours.';
                this.cmsLocalService.dspSnackbar(msg, 'OK', 20, 'warn');
                // this.cmsLocalService.dspSnackbar(this.t_data.ChangeSent, 'OK', 15);
                // record event
