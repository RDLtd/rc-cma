    ...
    dialogRef.afterClosed().subscribe(() => {
      ...
      if (f.dirty && !this.cancelSetting) {
        if (f.valid) {
          ...
          this.cms.sendRestaurantChanges(currentMember.member_first_name, currentMember.member_last_name,
            currentMember.member_email, this.restaurant.restaurant_name, changeArray)
            .subscribe(data => {
